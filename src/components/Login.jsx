                        ...
                        <div  className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 ">
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    <div className="mt-2">
                                        <img src={loginGuitar} className='w-20 h-20 ml-32' alt="guitar image" />
                                        <p className="text-base font-medium nt-5 text-center">Help us to become one of the safest places <br /> to buy and sell</p>
                                        <div className='flex border-2 border-black p-2 rounded-md mt-4 cursor-pointer'>
                                            <img src={phone} className='w-6 h-6' alt="phone logo" />
                                        ...
                                        <div onClick={googleSignIn} className='flex border border-gray-300 p-2 rounded-md mt-4 cursor-pointer'>
                                            <img src={google} className='w-6 h-6' alt="phone logo" />
